...
import de.femodeling.e4.ui.progress.internal.FinishedJobs.KeptJobsListener;
...
public class ProgressViewerContentProvider extends ProgressContentProvider {
	 ...
	 *            should be shown.
	 */
	public ProgressViewerContentProvider(Shell shell,AbstractProgressViewer structured,
	...
	private KeptJobsListener getKeptJobListener() {
		keptJobListener = new KeptJobsListener() {
			...
			public void finished(JobTreeElement jte) {
				...
				Job updateJob = new WorkbenchJob(shell,"Refresh finished") {//$NON-NLS-1$
					/*
					 * (non-Javadoc)
					 * 
			...
			public void removed(JobTreeElement jte) {
				final JobTreeElement element = jte;
				Job updateJob = new WorkbenchJob(shell,"Remove finished") {//$NON-NLS-1$
					/*
					 * (non-Javadoc)
					 * 
					 * @see org.eclipse.ui.progress.UIJob#runInUIThread(org.eclipse.core.runtime.IProgressMonitor)
