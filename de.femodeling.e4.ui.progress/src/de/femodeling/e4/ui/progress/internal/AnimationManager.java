...
public class AnimationManager {
    ...
    public static AnimationManager getInstance(Shell shell) {
        if (singleton == null) {
			singleton = new AnimationManager(shell);
		}
        return singleton;
    }
    ...
    AnimationManager(Shell shell) {

        animationProcessor = new ProgressAnimationProcessor(this);

        animationUpdateJob = new WorkbenchJob(shell,ProgressMessages.AnimationManager_AnimationStart) {
