...
import de.femodeling.e4.ui.progress.IProgressService;
import de.femodeling.e4.ui.progress.IWorkbenchSiteProgressService;
import de.femodeling.e4.ui.progress.WorkbenchJob;
...
public class WorkbenchSiteProgressService implements
    ...
    public class SiteUpdateJob extends WorkbenchJob {
        ...
        private SiteUpdateJob(Shell shell) {
            super(shell,ProgressMessages.WorkbenchSiteProgressService_CursorJob);
        }
        ...
        public IStatus runInUIThread(IProgressMonitor monitor) {
            ...
            synchronized (lock) {
                ...
                if (waitCursorJobCount !=0) {
					...
					cursor = getWaitCursor(shell.getDisplay());
				}
    ...
    */
	...
	public SiteUpdateJob getUpdateJob() {
		if(updateJob==null){
			updateJob = new SiteUpdateJob(shell);
