...
import de.femodeling.e4.ui.progress.IProgressConstants;
import de.femodeling.e4.ui.progress.IWindowTrim;
...
public class ProgressRegion implements IWindowTrim {
  ...
  //  WorkbenchWindow workbenchWindow;
     ...
     */
    public ProgressRegion(Shell shell) {
    	this.shell=shell;
        //No default behavior.
    }
    ...
    public Control createContents(Composite parent/*, WorkbenchWindow window*/) {
       // workbenchWindow = window;
        ...
        region = new Composite(parent, SWT.NONE) {
			...
			public Point computeSize(int wHint, int hHint, boolean changed) {
				...
				if (isHorizontal(side))
					size.y = IProgressConstants.TRIM_DEFAULT_HEIGHT;
				else {
					size.x = IProgressConstants.TRIM_DEFAULT_HEIGHT;
				}
				return size;
			}
		};
        ...
        IContentProvider provider = new ProgressViewerContentProvider(shell,viewer,
                false,false);
    ...
    */
	...
	public String getDisplayName() {
		return "TrimCommon_Progress_TrimName";
	}
