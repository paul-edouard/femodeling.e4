...
public class DeferredTreeContentManager {
	...
	@Inject
	IEclipseContext deferredContextAdapter;
	
	@Inject
	IEclipseContext contextAdapter;
	...
	*/
	...
	public IEclipseContext getDeferredContextAdapter() {
		return deferredContextAdapter;
	}

	public IEclipseContext getContextAdapter() {
	...
	protected IDeferredWorkbenchAdapter getAdapter(Object element) {
		...
		return (IDeferredWorkbenchAdapter) deferredContextAdapter.get(element.getClass());
		/*
	...
	protected void startFetchingDeferredChildren(final Object parent,
		...
		Job job = new Job(jobName) {
			...
			private IWorkbenchAdapter getWorkbenchAdapter(Object element) {
				...
				return (IWorkbenchAdapter) contextAdapter.get(element.getClass());
	...
	protected void addChildren(final Object parent, final Object[] children,
		...
		WorkbenchJob updateJob = new WorkbenchJob(shell,
	...
	protected void runClearPlaceholderJob(final PendingUpdateAdapter placeholder) {
		if (placeholder.isRemoved() || shell.isDisposed()) {
			return;
		}
		// Clear the placeholder if it is still there
		WorkbenchJob clearJob = new WorkbenchJob(shell,
