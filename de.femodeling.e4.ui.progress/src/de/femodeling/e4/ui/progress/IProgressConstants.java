...
public interface IProgressConstants {
	...
	static final String PLUGIN_ID="de.femodeling.e4.ui.progress";
	
	static final boolean DEBUG_SHOW_ALL_JOBS=true;
	
	static final int TRIM_DEFAULT_HEIGHT=100;
	

    /**
     * Common prefix for properties defined in this interface.
     */
    static final String PROPERTY_PREFIX = PLUGIN_ID
     ...
     * @see de.femodeling.e4.ui.progress.ui.progress.IProgressService
     **/
